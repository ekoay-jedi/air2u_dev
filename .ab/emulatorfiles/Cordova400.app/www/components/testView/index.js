...
(function () {
    ...
    var testView = kendo.observable({
        ...
        onShow: function (e) {
            ...
            $('#local-preview').hide();
            if (profile.Picture) {
                profile.PictureUrl = 'styles/img/white.png'; //app.constants.whitePicture;
                ...
                $('#preview').attr('src', 'styles/img/default.jpg');
            }
