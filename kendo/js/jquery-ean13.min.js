    ...
    return e = "EAN13", d = function () {
        function a(a, b, c) {
            ...
            if (this.element = a, this.number = b, this.settings = {
                ...
                }, c)for (d in c)this.settings[d] = c[d];
            this._name = e, this.init()
        }
        ...
        return a.prototype.settings = {}, a.prototype.init = function () {
            ...
            for (k = [[13, 25, 19, 61, 35, 49, 47, 59, 55, 11], [39, 51, 27, 33, 29, 57, 5, 17, 9, 23], [114, 102, 108, 66, 92, 78, 80, 68, 72, 116]], a = [0, 11, 13, 14, 19, 25, 28, 21, 22, 26], e = 0, i = 0, g = parseInt(this.number.substr(0, 1), 10), c = a[g], h = this.number.substr(1), f = h.split(""), d = 0; 5 >= d;)j = c >> 5 - d & 1, e *= Math.pow(2, 7), b = parseInt(f[d], 10), e += k[j][b], d++;
        ...
        return this.each(function () {
            return a.data(this, "plugin_" + e, new d(this, b, c))
        })
    }
