...
<script src="../js/adminAdminUsersManagement.js"></script>
</head>
<body> 
<div id="wrapper">
            ...
            <div class="row">
                <div class="col-md-2">
	                  <div class="btn-add-order">
	                      <button data-toggle="modal" data-target="#addAdminUserModal" class="btn btn-success btn-save btn-add btn-apply" onclick="javascript:void(0);getRoles();">Create A New Admin User</button>
	                  </div> 
                </div>
            </div>
...
<div class="modal fade" id="addAdminUserModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form>
                    ...
                    <div class="form-group">
                                            <label class="control-label" for="userRoleSelectEdit">Selects</label>
                                            <select class="form-control" id="userRoleSelectEdit">
												<option><span class="sr-only">Loading Data...</span></option>
                                            </select>
                    </div>  
                   <!--  <div class="row">
                    	<div class="form-group"  style="text-align: right;padding-right:15px;">
                    		<button id="resetPwdHref" onclick="sendEmailForPWd();">Reset Password</button>
                    	</div>
                    </div>  -->               
		        </form>
			</div>
